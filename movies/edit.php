                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control" id="title" name="title" value="<?= htmlspecialchars($old['title'] ?? $movie->title) ?>">
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="date" class="form-control" id="release_date" name="release_date" value="<?= htmlspecialchars($old['release_date'] ?? $movie->release_date) ?>">
                                    <div class="text-danger mt-1" style="min-height: 1.5em;">
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="input-group">
                                        <input type="number" class="form-control" id="rating" name="rating" step="0.01" value="<?= htmlspecialchars($old['rating'] ?? $movie->rating) ?>">
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="input-group">
                                        <input type="number" class="form-control" id="duration" name="duration" step="1" value="<?= htmlspecialchars($old['duration'] ?? $movie->duration) ?>">
                        ...
                        <div class="card-footer">
                            <div class="d-flex justify-content-between">
                                ...
                                <button type="submit" name="update_movie" class="btn btn-success">Save</button>
                            </div>
                        </div>
                    </div>
                </form>
