...
function sanitize_genres(array $genres, array $allowed_genres, array $errors): array
{
    if (empty($genres)) {
    ...
    // Return only the allowed genres, remove duplicates, and reindex the array neatly
    return array_values(array_unique(
        array_intersect($genres, $allowed_genres)
    ));
}

function sanitize_release_date($date, &$errors): ?string
{
    $date = trim($date);
